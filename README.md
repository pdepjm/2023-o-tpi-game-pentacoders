...
- Jugador 2 
  ...
  - Disparar: P
### Introducción
PentaWarriors es un juego combate en el espacio dinámico y con elementos aleatorios como cometas, powerUps y un enemigo que cambia de color, se mueve y dispara solo. 
